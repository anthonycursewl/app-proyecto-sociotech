...
export const useModuleGrid = () => {
  ...
  const modules: ModuleItem[] = [
    ...
    { id: "exams", title: "Exámenes", icon: "Microscope", color: "#8DB8B8", description: "Resultados de exámenes", route: "/exams", category: "clinical" },
    ...
    { id: "reports", title: "Reportes", icon: "FileBarChart", color: "#9FCDCD", description: "Reportes y documentos", route: "/reports", category: "admin" },
  ...
  const sections: CategorySection[] = CATEGORY_ORDER
    .map((catId) => {
