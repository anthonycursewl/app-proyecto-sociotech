...
export const ExamsHeader = ({ title = "Exámenes", onSearch }: ExamsHeaderProps) => {
    ...
    <View style={styles.wrapper}>
      ...
      <View style={[styles.container, { paddingTop: insets.top + 12 }]}>
        ...
        <View style={styles.bottomRow}>
          ...
          <Text style={styles.count}>24 exámenes</Text>
        </View>
        ...
        <View style={styles.filterRow}>
          ...
          <TouchableOpacity style={styles.filterChip}>
            <Text style={styles.filterChipText}>Completados</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.filterChip}>
            <Text style={styles.filterChipText}>Listos</Text>
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  bottomRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: 14, paddingHorizontal: 4 },
  ...
  filterChip: {
    paddingHorizontal: 14, paddingVertical: 6, borderRadius: 20, backgroundColor: "#FFFFFF",
    shadowColor: "#000", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 4, elevation: 1,
  },
  filterChipActive: { paddingHorizontal: 14, paddingVertical: 6, borderRadius: 20, backgroundColor: "#4CB1B1" },
  filterChipText: { fontSize: 13, color: "#64748B", fontWeight: "500" },
  filterChipTextActive: { fontSize: 13, color: "#FFFFFF", fontWeight: "600" },
  statsRow: {
