import { AlertCircle, Briefcase, Calendar, CheckCheck, Clock, User } from "lucide-react-native";
      ...
      <View style={styles.content}>
        <View style={styles.header}>
          <View style={styles.iconWrap}>
            <CheckCheck size={22} color="#15803D" strokeWidth={2.5} />
          </View>
        ...
        >
          <Text style={styles.subtitle}>
            ¿Estás seguro de marcar esta cita como completada? Esta acción no se puede deshacer.
          </Text>

          <View style={styles.detailRow}>
            <Briefcase size={14} color="#15803D" strokeWidth={2.5} />
          ...
          <View style={styles.detailRow}>
            <User size={14} color="#15803D" strokeWidth={2.5} />
            <View style={styles.detailTextBlock}>
              <Text style={styles.detailLabel}>Paciente</Text>
              <Text style={styles.detailValue}>
                {appointment.patient?.fullName ?? `#${appointment.patientId.slice(0, 8)}`}
              </Text>
            </View>
          </View>
          ...
          <View style={styles.detailRow}>
            <Clock size={14} color="#15803D" strokeWidth={2.5} />
            <View style={styles.detailTextBlock}>
          ...
          >
            {mutating ? (
              ...
              <>
                ...
                <Text style={styles.confirmText}>Sí, completar</Text>
              </>
            )}
          </TouchableOpacity>
        </View>
